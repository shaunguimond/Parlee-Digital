...
exports.default = ({ target, mode, outDir }) => (Object.assign(Object.assign({ filename: filenames[target][mode], path: path_1.resolve(rootPath, outDir, paths[target]), publicPath: "/static/" }, (target !== "server" && { chunkFilename: chunkFilenames[target][mode] })), (target === "server" && { libraryTarget: "commonjs2" })));

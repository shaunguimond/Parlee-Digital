...
export declare const normalizeOptions: (defaultOptions: Options, passedOptions: Options) => Options;
export declare const ensureProjectDir: (path: string) => Promise<boolean>;
export declare const createPackageJson: (name: string, theme: string, path: string) => Promise<void>;
